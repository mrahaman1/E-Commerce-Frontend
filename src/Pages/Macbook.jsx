...
const Macbook = () => {
  ...
  useEffect(()=>{
    fetch("https://ishop-backend-dfl7.onrender.com/accessories")
    .then(res=>res.json())
  ...
  const addToCart = (productId) => {
    ...
    axios.post("https://ishop-backend-dfl7.onrender.com/cart",data)
  ...
  return (
    <div className='parent'>
      {detail.filter((item)=> item.catagory=== "macbook").map((items, index)=>{
        return(
