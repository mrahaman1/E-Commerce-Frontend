...
const Userdetails = () => {
  ...
  const [price,setPrice]=useState(0)
    ...
    useEffect(()=>{
        fetch("https://ishop-backend-dfl7.onrender.com/profile",{
      method:"POST",
    ...
    // console.log(userdata)
      ...
      const deleteproduct=(productId)=>{
        ...
        axios.post("https://ishop-backend-dfl7.onrender.com/delete",data)
        .then(data=>{ 
      ...
      const placeorder=(productId)=>{
        ...
        console.log(userId)
        axios.post("https://ishop-backend-dfl7.onrender.com/update",data)
